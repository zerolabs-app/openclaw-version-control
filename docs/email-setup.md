...
This error is not caused by OpenClaw, your provider, or your App Password. It means something on your computer is intercepting the secure connection to your email provider and re-signing it, which OpenClaw correctly refuses to trust.
The most common cause is antivirus software with a "Mail Shield," "Web Shield," or "HTTPS scanning" feature. Avast is the most frequently reported cause.
Fix for Avast
1. Right-click the Avast icon in your Windows system tray
2. Choose "Avast shields control"
3. Select "Disable for 10 minutes"
4. Try Save Email Settings again
If it works after disabling Avast, go back into Avast and turn off Mail Shield specifically, under Menu → Settings → Protection → Core Shields. You do not need to disable the rest of Avast.
Other antivirus programs
Kaspersky, Bitdefender, Norton, ESET, and McAfee can cause the same error through similar scanning features. Look for a setting called "Mail Protection," "Web Protection," or "HTTPS/SSL scanning" and turn off just that feature, not the whole program.
This is a setting on your computer, not something that can be fixed inside OpenClaw.
---
